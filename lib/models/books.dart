...
class Answer {
    ...
    factory Answer.fromJson(Map<String, dynamic> json) => Answer(
        appearInBooks: json["appearInBooks"] == null ? [] : List<AppearInBook>.from(json["appearInBooks"]!.map((x) => AppearInBook.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "appearInBooks": appearInBooks == null ? [] : List<dynamic>.from(appearInBooks!.map((x) => x.toJson())),
    };
}
